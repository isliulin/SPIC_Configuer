...
QT_MOC_LITERAL(3, 29, 12), // "WSerialport*"
...
QT_MOC_LITERAL(9, 132, 26) // "on_RefreshButton_2_clicked"
    ...
    "Connection\0serialPortOpened\0\0WSerialport*\0"
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->serialPortOpened((*reinterpret_cast< WSerialport*(*)>(_a[1]))); break;
        ...
        {
            typedef void (Connection::*_t)(WSerialport * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Connection::serialPortOpened)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Connection::serialPortOpened(WSerialport * _t1)
{
