...
public:
    ...
    void setupUi(QDialog *SerialPort_Editer)
    {
        ...
        Manufacture->setGeometry(QRect(450, 40, 90, 20));
        ...
        Linklable_2 = new QLabel(groupBox_4);
        Linklable_2->setObjectName(QStringLiteral("Linklable_2"));
        Linklable_2->setGeometry(QRect(560, 40, 91, 16));
        Manufacture_Name = new QLineEdit(groupBox_4);
        Manufacture_Name->setObjectName(QStringLiteral("Manufacture_Name"));
        Manufacture_Name->setGeometry(QRect(300, 40, 90, 20));
        label_10 = new QLabel(groupBox_4);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(410, 40, 41, 16));
    ...
    void retranslateUi(QDialog *SerialPort_Editer)
    {
        ...
        Linklable_2->setText(QApplication::translate("SerialPort_Editer", "\350\216\267\345\217\226\345\271\263\345\217\260\345\217\202\346\225\260", Q_NULLPTR));
        label_10->setText(QApplication::translate("SerialPort_Editer", "\345\272\217\345\210\227\345\217\267", Q_NULLPTR));
