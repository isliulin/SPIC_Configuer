...
void Xconvert::InsertQulonglongTOList(qulonglong i, QByteArray &list)
{
    qulonglong a=i;
...
void Xconvert::InsertQuint16TOList(quint16 i, QByteArray &list)
{
...
void Xconvert::LRC(QByteArray &packet)
{
    int length=packet.length();
    quint8 lrc=packet.at(0);
