...
public:
    ...
    void setupUi(QDialog *Other_Editer)
    {
        ...
        layoutWidget_4->setGeometry(QRect(100, 180, 351, 24));
        ...
        lastVolumeText = new QLineEdit(groupBox_5);
        lastVolumeText->setObjectName(QStringLiteral("lastVolumeText"));
        lastVolumeText->setGeometry(QRect(110, 60, 90, 20));
        lastVolumeLbl = new QLabel(groupBox_5);
        lastVolumeLbl->setObjectName(QStringLiteral("lastVolumeLbl"));
        lastVolumeLbl->setGeometry(QRect(32, 60, 51, 16));
    ...
    void retranslateUi(QDialog *Other_Editer)
    {
        ...
        lastVolumeLbl->setText(QApplication::translate("Other_Editer", "\345\257\206\345\272\246", Q_NULLPTR));
